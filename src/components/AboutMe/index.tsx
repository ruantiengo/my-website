            ...
            <div className={styles.introdution}>
                ...
                <div className={styles.bio}>
                    <div className={styles.aboutMe}>
                        ...
                        <button type="button"><a href="others/curriculo.pdf" target="_blank" rel="noreferrer">CURRICULUM</a></button>
                    ...
                    <div className={styles.questions}>
                        ...
                        <div className={styles.questionsContainer}>
                            ...
                            <p className={styles.answer}>I'm person who loves to program. Since my first C code at university i just fell in love for programming.</p>
